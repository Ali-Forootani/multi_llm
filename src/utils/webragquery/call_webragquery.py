...
class WebRAGQuery:
    ...
    def call(self) -> str:
        """
        Call the LLM model (GPT) with web capabilities and return the response. The model can act as an 
        AI chatbot or based on the user's query, it can call a function and return the result.
